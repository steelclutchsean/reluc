...
export default function Dashboard() {
  ...
  const billingPortalUrl =
    process.env.NEXT_PUBLIC_STRIPE_BILLING_PORTAL_URL || "/#pricing";
    ...
    <main className="max-w-[720px] mx-auto px-5 pb-20">
      ...
      {activeTab === "playbook" && (
        <section className="animate-fade-in">
          <div className="glass-card rounded-[28px] p-8">
            ...
            <a
              href="/api/documents/reluctant-seller-playbook"
              download
      ...
      <footer className="text-center text-[13px] text-[rgba(60,60,67,0.3)] pt-12 mt-12 border-t border-[rgba(60,60,67,0.08)]">
        ...
        <p>
          ...
          <a href={billingPortalUrl} className="text-[#007AFF] hover:underline">
            Billing Portal
          </a>
        </p>
      </footer>
