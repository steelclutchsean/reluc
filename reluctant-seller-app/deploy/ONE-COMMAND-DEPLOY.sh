...
STRIPE_BILLING_PORTAL_URL=https://billing.stripe.com/p/login/REPLACE_ME
NEXT_PUBLIC_STRIPE_BILLING_PORTAL_URL=https://billing.stripe.com/p/login/REPLACE_ME

# Coinbase Commerce
COINBASE_COMMERCE_API_KEY=REPLACE_ME
COINBASE_WEBHOOK_SHARED_SECRET=REPLACE_ME
...
DATABASE_URL=postgresql://postgres:password@localhost:5432/reluctant_seller
